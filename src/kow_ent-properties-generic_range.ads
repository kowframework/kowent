...
generic
	...
	Null_Value : Val_Type;
package KOW_ENT.Properties.Generic_Range is
	...
	procedure Append is new APQ.Append_Integer( Val_Type => Val_Type );
	function Value is new APQ.Integer_Value( Val_Type => Val_Type );
	...
	type Setter_Callback is not null access procedure( Entity : in out Entity_Type'Class; Value : Val_Type );
...
end KOW_Ent.Properties.Generic_Range;
