...
generic
	...
	Null_Value : Val_Type;
package KOW_ENT.Properties.Generic_Mod is
	...
	procedure Append is new APQ.Append_Modular( Val_Type => Val_Type );
	function Value is new APQ.Modular_Value( Val_Type => Val_Type );
...
end KOW_Ent.Properties.Generic_Mod;
